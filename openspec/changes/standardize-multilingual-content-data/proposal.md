...
- Add structured bibliographic references and editorial review metadata so technical validity, translation completeness, source provenance, and scholarly review status can be distinguished.
...
- Add the missing non-Quran/non-hadith learning content incrementally across the seven stages, with Indonesian and English required before publication as reviewed content.
...
- `content-provenance-review`: Structured source references, publication states, translation review, scholarly review, and validation of content readiness.
...
- Content contributors must supply stable IDs, Indonesian and English text, structured references, and review metadata that pass validation.
